            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const Divider(height: 1),
                  MoreMenuRow(icon: Icons.gavel, title: 'featureDisputes'.tr(), subtitle: 'featureDisputesSubtitle'.tr(), onTap: () => context.push('/driver/profile/disputes')),
                  const Divider(height: 1),
                  MoreMenuRow(icon: Icons.add_road, title: 'featureCarpoolCreate'.tr(), subtitle: 'featureCarpoolCreateSubtitle'.tr(), onTap: () => context.push('/driver/profile/create-carpool')),
                  const Divider(height: 1),
                  MoreMenuRow(icon: Icons.event_seat, title: 'featureCarpoolMy'.tr(), subtitle: 'featureCarpoolMySubtitle'.tr(), onTap: () => context.push('/driver/profile/my-carpools')),
                  MoreMenuRow(icon: Icons.person_add, title: 'driverMenuInvite'.tr(), subtitle: 'featureReferralSubtitle'.tr(), onTap: () => context.push('/driver/profile/referral')),
                ],
              ),
            ),
